/*! For license information please see main.60ae3ace.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, t, n) {
  ...
  (n.m = e),
    ...
    (n.u = function (e) {
      return "static/js/" + e + ".6776b0b3.chunk.js";
    }),
    ...
    (function () {
      ...
      var t = function (t, r) {
        ...
        r = (self.webpackChunkcslocalizer = self.webpackChunkcslocalizer || []);
    ...
    (function () {
      ...
      function o() {
        ...
        function f(e, t, n, l) {
          var a = t && t.prototype instanceof h ? t : h,
            ...
            u = new P(l || []);
          return r(o, "_invoke", { value: x(e, n, u) }), o;
        }
        function d(e, t, n) {
          try {
                          ...
                          case 0:
                            t.preventDefault(),
                              fetch("/localize")
                                .then(function (e) {
                                  500 === e.status
                                    ? l("There was a problem with the server")
                                    : 200 === e.status &&
                                      l("Entry localized successfully");
                                })
                                .catch(function (e) {
                                  l("Error: " + e.message), console.log(e);
                                });
                          case 3:
                          case "end":
                            return e.stop();
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [
              (0, r.jsxs)("h4", {
                ...
                children: [
                  (0, r.jsx)("i", { className: "fa fa-download" }),
                  " Download Entry For Translation Services",
                ],
              }),
              (0, r.jsx)("p", {
                children:
                  'Clicking this button will create a zip file in the "Ready to Translate" folder within the assets section of Contentstack and then download the file to your local machine.',
              }),
              (0, r.jsx)(l, {}),
              (0, r.jsx)("br", {}),
              (0, r.jsx)("br", {}),
              ...
              (0, r.jsxs)("h4", {
                className: "display-4 text-center mb-4",
                children: [
                  (0, r.jsx)("i", { className: "fa fa-language" }),
                  " Localize Entry With Translated Zip File",
                ],
              }),
              (0, r.jsx)("p", {
                className: "alert",
                children:
                  'Before Clicking this button be sure that you have uploaded the translated zip file to the "Translated Files" folder in the assets section of contentstack added the description "READY TO LOCALIZE" and published the asset to the development environment.',
              }),
              (0, r.jsx)("p", {
                children:
                  "Clicking this button will Localize the entry with the translated files uploaded to Contentstack.",
              }),
              (0, r.jsx)(f, {}),
            ],
          });
      ...
      t
        ...
        .render((0, r.jsx)(e.StrictMode, { children: (0, r.jsx)(d, {}) })),
        p();
    })();
})();
//# sourceMappingURL=main.60ae3ace.js.map
